...
print("------------------------------")
print("THE GREGARIOUS GROCER")
print("------------------------------")
print("Web: www.greggroc.com")
print("Phone: 212.121.2112")
print(checkout_time.strftime("Checkout Time: %Y-%m-%d %H:%M:%S"))
#https://github.com/prof-rossetti/nyu-info-2335-201805/blob/master/notes/programming-languages/python/modules/datetime.md
print("------------------------------")
...
nyc_tax = raw_total * .08875
net_total = raw_total + nyc_tax
print("------------------------------")
print("Subtotal: " + "${0:.2f}".format(raw_total))
print("Plus NYC Sales Tax (8.875%): " + "${0:.2f}".format(nyc_tax))
